...
export const testQuestions: TestQuestion[] = [
  ...
  },
  {
    id: "rankup-ora",
    category: "Promovari",
    question: "In ce zi si la ce ora se acorda rank-up?",
    answer: "Duminica la ora 23:00.",
    accepted: ["duminica 23:00", "duminica la 23:00", "duminica ora 23", "duminica la ora 23:00", "duminica 23"],
  },
  {
    id: "promovare-sef-vechime",
    category: "Promovari",
    question: "Care este vechimea minima pentru promovarea Agent Operativ -> Agent Operativ Sef?",
    answer: "Minimum 7 zile.",
    accepted: ["7", "7 zile", "minimum 7 zile", "minim 7 zile"],
  },
  {
    id: "promovare-supervizor-vechime",
    category: "Promovari",
    question: "Care este vechimea minima pentru promovarea Agent Operativ Sef -> Supervizor Penitenciar?",
    answer: "Minimum 21 de zile.",
    accepted: ["21", "21 zile", "21 de zile", "minimum 21 zile", "minim 21 zile"],
  },
  {
    id: "pontaj",
    category: "Promovari",
    question: "Cate ore de pontaj sunt obligatorii pe saptamana pentru promovare?",
    answer: "10 ore pe saptamana.",
    accepted: ["10", "10 ore", "10 ore pe saptamana"],
  },
  {
  ...
  },
  {
    id: "agent-callsign",
    category: "Ierarhie",
    question: "De la ce callsign incep Agentii Operativi?",
    answer: "De la P-51.",
    accepted: ["p-51", "p51", "51", "de la p-51"],
  },
  {
    id: "sef-callsign",
    category: "Ierarhie",
    question: "Care este intervalul de callsign pentru Agent Operativ Sef?",
    answer: "P-20 pana la P-50.",
    accepted: ["p-20 p-50", "p20 p50", "p-20 pana la p-50", "20-50", "p-20 - p-50"],
  },
  {
